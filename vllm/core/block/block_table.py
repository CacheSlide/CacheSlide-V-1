...
class BlockTable:
    ...
    def __init__(
        ...
        self.selected_token_count: int = 0
    ...
    def mark_selected_token(self) -> None:
        """Mark this page as dirty and increment selected-token counter."""
        if not self.is_dirty:
            self.is_dirty = True
        self.selected_token_count += 1

    def reset_slide_metadata(self) -> None:
        """Call when the page is (re)allocated for a new use."""
        self.is_dirty = False
